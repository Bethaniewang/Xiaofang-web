    ...
    <>
      ...
      <Section>
        <div className="container-page">
          ...
          <h2 className="mt-4 text-4xl leading-tight text-teal sm:text-5xl">Clear, compassionate documentation.</h2>
      ...
      <Section className="bg-linen">
        <div className="container-page grid gap-8 lg:grid-cols-[0.65fr_1.35fr]">
          <div>
            ...
            <h2 className="mt-4 text-4xl leading-tight text-teal sm:text-5xl">A little more clarity.</h2>
          </div>
